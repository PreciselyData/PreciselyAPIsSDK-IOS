...
NSNumber* removeAccentMarks = @false; // Specifies whether to Suppress accents and other diacritical marks. (optional) (default to false)
 ...
 **removeAccentMarks** | **NSNumber***| Specifies whether to Suppress accents and other diacritical marks. | [optional] [default to false]
