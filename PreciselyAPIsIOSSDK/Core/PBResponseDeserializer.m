...
NSString *const PBDeserializationErrorDomainKey = @"PBDeserializationErrorDomainKey";

NSInteger const PBTypeMismatchErrorCode = 143553;

NSInteger const PBEmptyValueOccurredErrorCode = 143509;

NSInteger const PBUnknownResponseObjectErrorCode = 143528;


@interface PBResponseDeserializer ()
...
@implementation PBResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:PBDeserializationErrorDomainKey code:PBTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:PBDeserializationErrorDomainKey code:PBEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:PBDeserializationErrorDomainKey code:PBUnknownResponseObjectErrorCode userInfo:userInfo];
}
