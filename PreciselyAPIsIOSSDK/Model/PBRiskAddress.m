...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"objectId", @"formattedAddress", @"mainAddressLine", @"addressLastLine", @"placeName", @"areaName1", @"areaName2", @"areaName3", @"areaName4", @"postCode", @"postCodeExt", @"country", @"addressNumber", @"streetName", @"unitType", @"unitValue"];
