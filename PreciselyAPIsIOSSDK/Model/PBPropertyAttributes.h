...
@protocol PBBuildgImprovArea;
@class PBBuildgImprovArea;
...
@property(nonatomic) NSString* propCensusTract;
...
@property(nonatomic) NSArray<PBBuildgImprovArea>* buildgImprovArea;
