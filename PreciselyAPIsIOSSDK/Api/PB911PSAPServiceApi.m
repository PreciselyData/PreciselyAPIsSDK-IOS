#import "PB911PSAPServiceApi.h"
#import "PBQueryParamCollection.h"
#import "PBAHJPlusPSAPResponse.h"
#import "PBPSAPResponse.h"


@interface PB911PSAPServiceApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation PB911PSAPServiceApi

NSString* kPB911PSAPServiceApiErrorDomain = @"PB911PSAPServiceApiErrorDomain";
NSInteger kPB911PSAPServiceApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static PB911PSAPServiceApi *sharedAPI;
...
-(NSNumber*) getAHJPlusPSAPByAddressWithAddress: (NSString*) address
    ...
    if (address == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kPB911PSAPServiceApiErrorDomain code:kPB911PSAPServiceApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
